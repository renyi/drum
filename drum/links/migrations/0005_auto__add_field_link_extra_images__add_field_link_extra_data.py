...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Link.extra_images'
        db.add_column(u'links_link', 'extra_images',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Link.extra_data'
        db.add_column(u'links_link', 'extra_data',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Link.extra_images'
        db.delete_column(u'links_link', 'extra_images')

        # Deleting field 'Link.extra_data'
        db.delete_column(u'links_link', 'extra_data')
    ...
    models = {
        ...
        u'links.link': {
            ...
            'extra_images': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
