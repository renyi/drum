...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'links_link', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['links.LinkCategory'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'links.link': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['links.LinkCategory']", 'null': 'True', 'blank': 'True'}),
